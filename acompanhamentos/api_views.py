    ...
    try:
        ...
        requisicao, created = RequisicaoSolicitacao.objects.update_or_create(
            ...
            defaults={
                ...
                'origem_2': data.get('origem_2'),
                'latitude_origem_2': data.get('latitude_origem_2'),
                'longitude_origem_2': data.get('longitude_origem_2'),
                'origem_3': data.get('origem_3'),
                'latitude_origem_3': data.get('latitude_origem_3'),
                'longitude_origem_3': data.get('longitude_origem_3'),
                'destino': data.get('destino', ''),
                'latitude_destino': data.get('latitude_destino'),
                'longitude_destino': data.get('longitude_destino'),
                'destino_2': data.get('destino_2', ''),
                'latitude_destino_2': data.get('latitude_destino_2'),
                'longitude_destino_2': data.get('longitude_destino_2'),
                'destino_3': data.get('destino_3', ''),
                'latitude_destino_3': data.get('latitude_destino_3'),
                'longitude_destino_3': data.get('longitude_destino_3'),
